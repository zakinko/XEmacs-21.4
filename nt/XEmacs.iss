...
[Files]
; Before you run this script, XEmacs-21.4 must be installed in c:\Program Files\XEmacs\XEmacs-21.4.xx
; and any packages you want to include must be installed in c:\Program Files\XEmacs\{xemacs,mule,site}-packages
Source: "C:\Program Files\XEmacs\*"; Excludes: "C:\Program Files\XEmacs\XEmacs-21.5*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
...
begin
  ...
  //   (setq package-get-package-index-file-location "C:\\Program Files\XEmacs\\XEmacs-21.4.18\\etc")
